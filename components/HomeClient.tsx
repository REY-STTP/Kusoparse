...
export default function HomeClient() {
  ...
  return (
    ...
    >
      ...
      >
        <span className="text-outline font-display font-black text-[10rem] leading-none">
          KUSO
        </span>
      </div>
      ...
      <div className="flex-1 w-full max-w-2xl mx-auto px-5 pt-6 sm:pt-8 pb-8">
        ...
        <header className="mb-12">
          ...
          >
            <span className="text-kuso-accent mr-2" aria-hidden="true">
              ●
            </span>
          ...
          <div
            aria-hidden="true"
            className="mt-4 flex flex-wrap items-center gap-x-3 gap-y-2 font-display font-black text-2xl sm:text-4xl leading-[0.95]"
          >
            {t.header.headlineLead.map((word, wi) => (
        ...
        <section aria-labelledby="parser-title" id="parser">
          <h2 id="parser-title" className="sr-only">
            {t.header.badge}
          </h2>
        ...
        >
          <AnimatePresence mode="wait">
            ...
            {error && !loading && (
              ...
              >
                <AlertOctagon className="w-6 h-6 shrink-0" aria-hidden="true" />
                <div>
